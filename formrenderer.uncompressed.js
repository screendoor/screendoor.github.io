        ...
        success: (function(_this) {
          return function(data, status, xhr) {
            ...
            if (xhr.getResponseHeader('jwt_token') != null) {
              _this.options.jwtToken = xhr.getResponseHeader('jwt_token');
            }
        ...
        error: (function(_this) {
          return function(xhr) {
            ...
            if (!_this.corsSupported()) {
              ...
              return _this.$el.find('.fr_loading').html("<p>" + ((_ref1 = xhr.responseJSON) != null ? _ref1.template : void 0) + "</p>");
            } else {
              _this.$el.find('.fr_loading').text("" + FormRenderer.t.error_loading + ": \"" + (((_ref2 = xhr.responseJSON) != null ? _ref2.error : void 0) || 'Unknown') + "\"");
